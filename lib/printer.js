...
module.exports = {
	theShot: function(dir, delay, selector, iszip) {
		var curi = cdir.split("\\")
		curi = curi.join("/") 
	...
	init: function(delay, folders, selector, iszip) {
		...
		if(arr.constructor === Array) {
			arr.forEach(function (val) {
				module.exports.theShot(val, delay, selector, iszip)
			})
		} else {
			module.exports.theShot(folder, delay, selector, iszip)
		}
	}	
}